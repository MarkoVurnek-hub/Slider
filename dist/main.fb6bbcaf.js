...
function init() {
  ...
  var currentStep = 1;
  var totalSlides = document.querySelectorAll(".project").length;
  createTimelineIn("next", currentStep);

  function createTimelineIn(direction, index) {
    var goPrev = direction === "prev";
    var element = document.querySelector("div.project0" + index),
  ...
  function transition(direction, toIndex) {
    ...
    var tlIn = createTimelineIn(direction, toIndex),
  ...
  document.querySelector("button.next").addEventListener("click", function (e) {
    e.preventDefault();
    var isLast = currentStep === totalSlides;
    var nextStep = isLast ? 1 : currentStep + 1;
  ...
  document.querySelector("button.prev").addEventListener("click", function (e) {
    ...
    var prevStep = isFirst ? totalSlides : currentStep - 1;
  ...
  function createNavigation() {
    ...
    var spot = document.createElement("spot");
    ...
    var _loop = function _loop(i) {
      ...
      element.addEventListener("click", function () {
        if (!isTweening() && currentStep !== i) {
          var direction = i > currentStep ? "next" : "prev";
  ...
  function positionDot() {
    var activeDotX = document.querySelector(".dot.active").offsetLeft;
    var spot = document.querySelector(".spot");
    var spotX = spot.offsetLeft;
    var destinationX = Math.round(activeDotX - spotX + 5);
    var dotTl = gsap.timeline();
    dotTl.to(spot, {
      duration: 0.4,
      x: destinationX,
      scale: 2.5,
...
},{}]},{},["../../.nvm/versions/node/v15.5.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/main.js"], null)
